...
import 'package:mylekha_cd_app/widgets/Text/title_2xl_widget.dart';
import 'package:mylekha_cd_app/widgets/home/home_card_menu_widget.dart';
        ...
        child: Padding(
          ...
          child: Center(
            child: Container(
              ...
              child: Column(
                children: [
                  Title2xlWidget(text: 'CUSTOMER DISPLAY'),
                  SizedBox(height: 40),
                  Row(
                    ...
                    children: [
                      HomeCardMenuWidget(
                        ...
                        onTap: () {
                          GoRouter.of(context).go(RouteNames.LIVE_CART_PATH);
                        },
                      ),
